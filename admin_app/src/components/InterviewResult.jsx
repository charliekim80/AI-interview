        ...
        <div className="space-y-6 max-w-5xl mx-auto pb-12">
            ...
            <div className="flex items-center justify-between border-b border-slate-200 pb-6">
                <div className="flex items-center gap-4">
                    <button onClick={onBack} className="p-2 -ml-2 text-slate-400 hover:text-slate-600 hover:bg-slate-100 rounded-xl transition-colors no-print">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                            <div className="bg-blue-50/50 rounded-2xl p-4 md:p-5 border border-blue-100">
                                ...
                                <ul className="space-y-2">
                                    {strengths.map((s, i) => (
                                        <li key={i} className="text-xs md:text-sm text-blue-700 flex items-start gap-2">
